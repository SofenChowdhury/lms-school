...
function skinChanger() {
	$(".choose-skin li").on("click", function () {
		...
		$(".choose-skin li").removeClass("active"), a.removeClass("theme-" + c), b.addClass("active");
		var d = $(".choose-skin li.active").data("theme");
		a.addClass("theme-" + b.data("theme"));
		"orange" == d || "purple" == d || "green" == d ? $("#left-sidebar .navbar-brand .logo").attr("src", "../assets/images/icon-dark.svg") : $("#left-sidebar .navbar-brand .logo").attr("src", "../assets/images/icon-light.svg")
	})
}
...
function CustomJs() {
	...
	$("#main-menu1").metisMenu(), $("#left-sidebar1 .sidebar-scroll").slimScroll({
		height: "calc(100vh - 65px)",
		wheelStep: 10,
		touchScrollStep: 50,
		color: "#efefef",
		...
		$("body").toggleClass("offcanvas-active")
	}), $("#main-content1").on("click", function () {
		$("body").removeClass("offcanvas-active")
	}), $(".right_toggle, .overlay").on("click", function () {
		$("#rightbar").toggleClass("open"), $(".overlay").toggleClass("open")
	}), $(".dropdown").on("show.bs.dropdown", function () {
		...
		$("#main-content").height() < $("#left-sidebar1").height() && $("#main-content").css("min-height", $("#left-sidebar1").innerHeight() - $("footer").innerHeight())
	}), $(window).on("load resize", function () {
		$(window).innerWidth() < 420 ? $(".navbar-brand logo.svg").attr("src", "../assets/images/icon-light.svg") : $(".navbar-brand icon-light.svg").attr("src", "../assets/images/logo.svg")
	}), $('[data-toggle="cardloading"]').on("click", function () {
		var a = $(this).data("loadingEffect"),
