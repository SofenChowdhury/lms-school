                                            ...
                                            <div class="event-single">
                                                ...
                                                <div class="event-details">
                                                    ...
                                                    <ul class="list-unstyled">
                                                        <li><i class="fa fa-calendar"></i> {{ $key->date }}</li>
                                                        <li><i class="fas fa-clock"></i> {{ $key->event_time }}</li>
                                                        <li><i class="fa fa-map-marker"></i> {{ $key->location }}</li>
                                                    </ul>
                                                    <p>{!! $key->short_description !!}</p>
                                                    <a href="{{ route('event-description-page',['id'=>$key->id]) }}">Read More <i class="fa fa-long-arrow-right"></i></a>
                                                </div>
                                            </div>
