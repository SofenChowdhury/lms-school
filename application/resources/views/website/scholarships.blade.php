                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                @foreach($manage_scholarship as $scholarship )
                                    <div class="col-md-9">
                                        <h2 style="font-family: inherit">{{$scholarship ->title}}</h2><br>
                                    </div>
                                    <!-- <div class="col-md-5">
                                        <img src="{{asset('frontend/images/school/horizn.jpeg')}}" style="width:100%;">
                                    </div> -->
                                    <div class="col-md-12">
                                        <p style="text-align: justify;">
                                            <img src="{{asset('uploads').'/'.$scholarship ->image}}"style="float: left;padding-right: 20px; width: 400px; padding-bottom: 20px;">
