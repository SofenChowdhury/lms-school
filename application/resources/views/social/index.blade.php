...
<div class="grid grid-3-6-3 mobile-prefer-content" style="margin-top: -20px;">
  ...
  <div class="grid-column">
    ...
    <div class="widget-box">
      ...
      <div class="achievement-status-list">
        ...
        <div class="achievement-status">
          ...
          <img class="achievement-status-image" src="{{asset('assets/frontend/img/badge/completedq-s.png')}}" alt="bdage-completedq-s">
          <!-- /ACHIEVEMENT STATUS IMAGE -->
        </div>
        <!-- /ACHIEVEMENT STATUS -->
        ...
        <div class="achievement-status">
          ...
          <!-- ACHIEVEMENT STATUS IMAGE -->
          <img class="achievement-status-image" src="{{asset('assets/frontend/img/badge/unlocked-badge.png')}}" alt="bdage-unlocked-badge">
          <!-- /ACHIEVEMENT STATUS IMAGE -->
        </div>
        <!-- /ACHIEVEMENT STATUS -->
      </div>
        ...
        <div id="badge-stat-slider-items" class="widget-box-content-slider">
          ...
          <div class="widget-box-content-slider-item">
            ...
            <div class="badge-item-stat void">
              ...
              <img class="badge-item-stat-image" src="{{asset('assets/frontend/img/badge/uexp-b.png')}}" alt="badge-uexp-b">
              <!-- /BADGE ITEM STAT IMAGE -->
          ...
          <div class="widget-box-content-slider-item">
            ...
            <div class="badge-item-stat void">
              ...
              <!-- BADGE ITEM STAT IMAGE -->
              <img class="badge-item-stat-image" src="{{asset('assets/frontend/img/badge/verifieds-b.png')}}" alt="badge-verifieds-b">
              <!-- /BADGE ITEM STAT IMAGE -->
          ...
          <div class="widget-box-content-slider-item">
            ...
            <div class="badge-item-stat void">
              ...
              <!-- BADGE ITEM STAT IMAGE -->
              <img class="badge-item-stat-image" src="{{asset('assets/frontend/img/badge/qconq-b.png')}}" alt="badge-qconq-b">
              <!-- /BADGE ITEM STAT IMAGE -->
          ...
          <div class="user-status request-small">
            ...
            <a class="user-status-avatar" href="profile-timeline.html">
              ...
              <div class="user-avatar small no-outline">
                ...
                <div class="user-avatar-content">
                  <!-- HEXAGON -->
                  <div class="hexagon-image-30-32" data-src="{{asset('assets/frontend/img/avatar/15.jpg')}}"></div>
                  <!-- /HEXAGON -->
                </div>
                <!-- /USER AVATAR CONTENT -->
    ...
    <a class="banner-promo" href="#" target="_blank">
      <img src="{{asset('assets/frontend/img/banner/banner-promo.jpg')}}" alt="banner-promo">
    </a>
    <!-- /BANNER PROMO -->
        ...
        <div class="quest-preview-list">
          ...
          <div class="quest-preview">
            ...
            <div class="quest-preview-info">
              <!-- QUEST PREVIEW IMAGE -->
              <img class="quest-preview-image" src="{{asset('assets/frontend/img/quest/openq-s.png')}}" alt="openq-s">
              <!-- /QUEST PREVIEW IMAGE -->
            ...
            <div class="content-action">
              ...
              <div class="meta-line">
                ...
                <div class="meta-line-list reaction-item-list">
                  ...
                  <div class="reaction-item">
                    <!-- REACTION IMAGE -->
                    <img class="reaction-image reaction-item-dropdown-trigger" src="{{asset('assets/frontend/img/reaction/happy.png')}}" alt="reaction-happy">
                    <!-- /REACTION IMAGE -->
        
                    <!-- SIMPLE DROPDOWN -->
                    <div class="simple-dropdown padded reaction-item-dropdown">
                      <!-- SIMPLE DROPDOWN TEXT -->
                      <p class="simple-dropdown-text"><img class="reaction" src="{{asset('assets/frontend/img/reaction/happy.png')}}" alt="reaction-happy"> <span class="bold">Happy</span></p>
                      <!-- /SIMPLE DROPDOWN TEXT -->
              ...
              <div class="meta-line">
                ...
                <div class="meta-line-list user-avatar-list">
                  ...
                  <div class="user-avatar micro no-stats">
                    ...
                    <div class="user-avatar-content">
                      <!-- HEXAGON -->
                      <div class="hexagon-image-18-20" data-src="{{asset('assets/frontend/img/avatar/13.jpg')}}"></div>
                      <!-- /HEXAGON -->
                    </div>
                    <!-- /USER AVATAR CONTENT -->
                  </div>
                  ...
                  <div class="user-avatar micro no-stats">
                    ...
                    <div class="user-avatar-content">
                      <!-- HEXAGON -->
                      <div class="hexagon-image-18-20" data-src="{{asset('assets/frontend/img/avatar/22.jpg')}}"></div>
                      <!-- /HEXAGON -->
                    </div>
                    <!-- /USER AVATAR CONTENT -->
                  </div>
            ...
            <div class="content-action">
              ...
              <div class="meta-line">
                ...
                <div class="meta-line-list reaction-item-list">
                  ...
                  <div class="reaction-item">
                    <!-- REACTION IMAGE -->
                    <img class="reaction-image reaction-item-dropdown-trigger" src="{{asset('assets/frontend/img/reaction/funny.png')}}" alt="reaction-funny">
                    <!-- /REACTION IMAGE -->
        
                    <!-- SIMPLE DROPDOWN -->
                    <div class="simple-dropdown padded reaction-item-dropdown">
                      <!-- SIMPLE DROPDOWN TEXT -->
                      <p class="simple-dropdown-text"><img class="reaction" src="{{asset('assets/frontend/img/reaction/funny.png')}}" alt="reaction-funny"> <span class="bold">Funny</span></p>
                      <!-- /SIMPLE DROPDOWN TEXT -->
            ...
            <div class="picture-collage-row medium">
              ...
              <div class="picture-collage-item popup-picture-trigger">
                ...
                <div class="photo-preview">
                  ...
                  <figure class="photo-preview-image liquid">
                    <img src="{{asset('assets/frontend/img/cover/10.jpg')}}" alt="photo-preview-10">
                  </figure>
                  <!-- /PHOTO PREVIEW IMAGE -->
              ...
              <div class="picture-collage-item popup-picture-trigger">
                ...
                <div class="photo-preview">
                  <!-- PHOTO PREVIEW IMAGE -->
                  <figure class="photo-preview-image liquid">
                    <img src="{{asset('assets/frontend/img/cover/12.jpg')}}" alt="photo-preview-12">
                  </figure>
                  <!-- /PHOTO PREVIEW IMAGE -->
            ...
            <div class="picture-collage-row">
              ...
              <div class="picture-collage-item popup-picture-trigger">
                ...
                <div class="photo-preview">
                  <!-- PHOTO PREVIEW IMAGE -->
                  <figure class="photo-preview-image liquid">
                    <img src="{{asset('assets/frontend/img/cover/16.jpg')}}" alt="photo-preview-16">
                  </figure>
                  <!-- /PHOTO PREVIEW IMAGE -->
              ...
              <div class="picture-collage-item popup-picture-trigger">
                ...
                <div class="photo-preview">
                  <!-- PHOTO PREVIEW IMAGE -->
                  <figure class="photo-preview-image liquid">
                    <img src="{{asset('assets/frontend/img/cover/08.jpg')}}" alt="photo-preview-08">
                  </figure>
                  <!-- /PHOTO PREVIEW IMAGE -->
              ...
              <div class="picture-collage-item">
                ...
                <div class="photo-preview">
                  <!-- PHOTO PREVIEW IMAGE -->
                  <figure class="photo-preview-image liquid">
                    <img src="{{asset('assets/frontend/img/cover/14.jpg')}}" alt="photo-preview-14">
                  </figure>
                  <!-- /PHOTO PREVIEW IMAGE -->
            ...
            <div class="content-action">
              ...
              <div class="meta-line">
                ...
                <div class="meta-line-list reaction-item-list">
                  ...
                  <div class="reaction-item">
                    <!-- REACTION IMAGE -->
                    <img class="reaction-image reaction-item-dropdown-trigger" src="{{asset('assets/frontend/img/reaction/wow.png')}}" alt="reaction-wow">
                    <!-- /REACTION IMAGE -->
        
                    <!-- SIMPLE DROPDOWN -->
                    <div class="simple-dropdown padded reaction-item-dropdown">
                      <!-- SIMPLE DROPDOWN TEXT -->
                      <p class="simple-dropdown-text"><img class="reaction" src="{{asset('assets/frontend/img/reaction/wow.png')}}" alt="reaction-wow"> <span class="bold">Wow</span></p>
                      <!-- /SIMPLE DROPDOWN TEXT -->
          ...
          <div class="widget-box no-padding">
            ...
            <div class="widget-box-status">
              ...
              <div class="widget-box-status-content">
                ...
                <!-- VIDEO STATUS -->
                <a class="video-status" href="#" target="_blank">
                  <!-- VIDEO STATUS IMAGE -->
                  <img class="video-status-image" src="{{asset('assets/frontend/img/cover/51.jpg')}}" alt="cover-51">
                  <!-- /VIDEO STATUS IMAGE -->
          ...
          <div class="user-status">
            ...
            <div class="user-status-title medium"><a class="bold" href="profile-timeline.html">Neko Bebop</a> replied to the discussion <a class="bold" href="forums-discussion.html">In your opinion, who has the best Cosplay?</a> in the forum
              ...
              <a class="user-avatar micro no-stats" href="group-timeline.html">
                ...
                <div class="user-avatar-content">
                  <!-- HEXAGON -->
                  <div class="hexagon-image-18-20" data-src="{{asset('assets/frontend/img/avatar/24.jpg')}}"></div>
                  <!-- /HEXAGON -->
                </div>
                <!-- /USER AVATAR CONTENT -->
              </a>
                ...
                <div class="meta-line">
                  ...
                  <div class="meta-line-list user-avatar-list">
                    ...
                    <div class="user-avatar micro no-stats">
                      ...
                      <div class="user-avatar-content">
                        <!-- HEXAGON -->
                        <div class="hexagon-image-18-20" data-src="{{asset('assets/frontend/img/avatar/05.jpg')}}"></div>
                        <!-- /HEXAGON -->
                      </div>
                      <!-- /USER AVATAR CONTENT -->
                    </div>
                    ...
                    <div class="user-avatar micro no-stats">
                      ...
                      <div class="user-avatar-content">
                        <!-- HEXAGON -->
                        <div class="hexagon-image-18-20" data-src="{{asset('assets/frontend/img/avatar/30.jpg')}}"></div>
                        <!-- /HEXAGON -->
                      </div>
                      <!-- /USER AVATAR CONTENT -->
                    </div>
                    ...
                    <div class="user-avatar micro no-stats">
                      ...
                      <div class="user-avatar-content">
                        <!-- HEXAGON -->
                        <div class="hexagon-image-18-20" data-src="{{asset('assets/frontend/img/avatar/04.jpg')}}"></div>
                        <!-- /HEXAGON -->
                      </div>
                      <!-- /USER AVATAR CONTENT -->
                    </div>
                ...
                <div class="meta-line">
                  ...
                  <div class="meta-line-list user-avatar-list">
                    ...
                    <div class="user-avatar micro no-stats">
                      ...
                      <div class="user-avatar-content">
                        <!-- HEXAGON -->
                        <div class="hexagon-image-18-20" data-src="{{asset('assets/frontend/img/avatar/21.jpg')}}"></div>
                        <!-- /HEXAGON -->
                      </div>
                      <!-- /USER AVATAR CONTENT -->
                    </div>
                    ...
                    <div class="user-avatar micro no-stats">
                      ...
                      <div class="user-avatar-content">
                        <!-- HEXAGON -->
                        <div class="hexagon-image-18-20" data-src="{{asset('assets/frontend/img/avatar/19.jpg')}}"></div>
                        <!-- /HEXAGON -->
                      </div>
                      <!-- /USER AVATAR CONTENT -->
                    </div>
                ...
                <div class="meta-line">
                  ...
                  <div class="meta-line-list user-avatar-list">
                    ...
                    <div class="user-avatar micro no-stats">
                      ...
                      <div class="user-avatar-content">
                        <!-- HEXAGON -->
                        <div class="hexagon-image-18-20" data-src="{{asset('assets/frontend/img/avatar/18.jpg')}}"></div>
                        <!-- /HEXAGON -->
                      </div>
                      <!-- /USER AVATAR CONTENT -->
                    </div>
                    ...
                    <div class="user-avatar micro no-stats">
                      ...
                      <div class="user-avatar-content">
                        <!-- HEXAGON -->
                        <div class="hexagon-image-18-20" data-src="{{asset('assets/frontend/img/avatar/02.jpg')}}"></div>
                        <!-- /HEXAGON -->
                      </div>
                      <!-- /USER AVATAR CONTENT -->
                    </div>
        ...
        <div id="reaction-stat-slider-items" class="widget-box-content-slider">
          ...
          <div class="widget-box-content-slider-item">
            ...
            <div class="reaction-stats">
              ...
              <div class="reaction-stat">
                <!-- REACTION STAT IMAGE -->
                <img class="reaction-stat-image" src="{{asset('assets/frontend/img/reaction/like.png')}}" alt="reaction-like">
                <!-- /REACTION STAT IMAGE -->
              ...
              <div class="reaction-stat">
                <!-- REACTION STAT IMAGE -->
                <img class="reaction-stat-image" src="{{asset('assets/frontend/img/reaction/love.png')}}" alt="reaction-love">
                <!-- /REACTION STAT IMAGE -->
            ...
            <div class="reaction-stats">
              ...
              <div class="reaction-stat">
                <!-- REACTION STAT IMAGE -->
                <img class="reaction-stat-image" src="{{asset('assets/frontend/img/reaction/dislike.png')}}" alt="reaction-dislike">
                <!-- /REACTION STAT IMAGE -->
              ...
              <div class="reaction-stat">
                <!-- REACTION STAT IMAGE -->
                <img class="reaction-stat-image" src="{{asset('assets/frontend/img/reaction/happy.png')}}" alt="reaction-happy">
                <!-- /REACTION STAT IMAGE -->
          ...
          <div class="widget-box-content-slider-item">
            ...
            <div class="reaction-stats">
              ...
              <div class="reaction-stat">
                <!-- REACTION STAT IMAGE -->
                <img class="reaction-stat-image" src="{{asset('assets/frontend/img/reaction/funny.png')}}" alt="reaction-funny">
                <!-- /REACTION STAT IMAGE -->
              ...
              <div class="reaction-stat">
                <!-- REACTION STAT IMAGE -->
                <img class="reaction-stat-image" src="{{asset('assets/frontend/img/reaction/wow.png')}}" alt="reaction-wow">
                <!-- /REACTION STAT IMAGE -->
            ...
            <div class="reaction-stats">
              ...
              <div class="reaction-stat">
                <!-- REACTION STAT IMAGE -->
                <img class="reaction-stat-image" src="{{asset('assets/frontend/img/reaction/angry.png')}}" alt="reaction-angry">
                <!-- /REACTION STAT IMAGE -->
              ...
              <div class="reaction-stat">
                <!-- REACTION STAT IMAGE -->
                <img class="reaction-stat-image" src="{{asset('assets/frontend/img/reaction/sad.png')}}" alt="reaction-sad">
                <!-- /REACTION STAT IMAGE -->
