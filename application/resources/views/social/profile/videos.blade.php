      ...
      <div class="grid grid-3-3-3-3 centered">
        ...
        <div class="video-box">
          ...
          <div class="video-box-cover popup-video-trigger">
            <!-- VIDEO BOX COVER IMAGE -->
            <figure class="video-box-cover-image liquid">
              <img src="{{asset('assets/frontend/img/cover/22.jpg')}}" alt="cover-22">
            </figure>
            <!-- /VIDEO BOX COVER IMAGE -->
        ...
        <div class="video-box">
          ...
          <div class="video-box-cover popup-video-trigger">
            <!-- VIDEO BOX COVER IMAGE -->
            <figure class="video-box-cover-image liquid">
              <img src="{{asset('assets/frontend/img/cover/02.jpg')}}" alt="cover-02">
            </figure>
            <!-- /VIDEO BOX COVER IMAGE -->
        ...
        <div class="video-box">
          ...
          <div class="video-box-cover popup-video-trigger">
            <!-- VIDEO BOX COVER IMAGE -->
            <figure class="video-box-cover-image liquid">
              <img src="{{asset('assets/frontend/img/cover/21.jpg')}}" alt="cover-21">
            </figure>
            <!-- /VIDEO BOX COVER IMAGE -->
        ...
        <div class="video-box">
          ...
          <div class="video-box-cover popup-video-trigger">
            <!-- VIDEO BOX COVER IMAGE -->
            <figure class="video-box-cover-image liquid">
              <img src="{{asset('assets/frontend/img/cover/23.jpg')}}" alt="cover-23">
            </figure>
            <!-- /VIDEO BOX COVER IMAGE -->
