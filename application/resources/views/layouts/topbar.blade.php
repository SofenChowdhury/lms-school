    ...
    <div class="header-actions search-bar">
      ...
      <div class="dropdown-box padding-bottom-small header-search-dropdown">
        ...
        <div class="dropdown-box-list small no-scroll">
          ...
          <a class="dropdown-box-list-item" href="{{route('profile')}}">
            <!-- USER STATUS -->
            ...
            <div class="user-status no-padding-top">
              ...
              <div class="user-status-avatar">
                ...
                <figure class="picture small round liquid">
                  <img src="{{asset('assets/frontend/img/marketplace/items/07.jpg')}}" alt="item-07">
                </figure>
                <!-- /PICTURE -->
              </div>
              <!-- /USER STATUS AVATAR -->
                ...
                <div class="cart-item-preview">
                  ...
                  <a class="cart-item-preview-image" href="marketplace-product.html">
                    ...
                    <figure class="picture medium round liquid">
                      <img src="{{asset('assets/frontend/img/marketplace/items/01.jpg')}}" alt="item-01">
                    </figure>
                    <!-- /PICTURE -->
                  </a>
                  <!-- /CART ITEM PREVIEW IMAGE -->
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="cart-item-preview">
                  ...
                  <a class="cart-item-preview-image" href="marketplace-product.html">
                    <!-- PICTURE -->
                    <figure class="picture medium round liquid">
                      <img src="{{asset('assets/frontend/img/marketplace/items/11.jpg')}}" alt="item-11">
                    </figure>
                    <!-- /PICTURE -->
                  </a>
                  <!-- /CART ITEM PREVIEW IMAGE -->
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="cart-item-preview">
                  ...
                  <a class="cart-item-preview-image" href="marketplace-product.html">
                    <!-- PICTURE -->
                    <figure class="picture medium round liquid">
                      <img src="{{asset('assets/frontend/img/marketplace/items/10.jpg')}}" alt="item-10">
                    </figure>
                    <!-- /PICTURE -->
                  </a>
                  <!-- /CART ITEM PREVIEW IMAGE -->
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="cart-item-preview">
                  ...
                  <a class="cart-item-preview-image" href="marketplace-product.html">
                    <!-- PICTURE -->
                    <figure class="picture medium round liquid">
                      <img src="{{asset('assets/frontend/img/marketplace/items/04.jpg')}}" alt="item-04">
                    </figure>
                    <!-- /PICTURE -->
                  </a>
                  <!-- /CART ITEM PREVIEW IMAGE -->
            ...
            <div class="dropdown-box-list no-hover" data-simplebar>
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="user-status request">
                  ...
                  <!-- USER STATUS TITLE -->
                  <p class="user-status-title"><a class="bold" href="{{route('profile')}}">Ginny Danvers</a></p>
                  <!-- /USER STATUS TITLE -->
                ...
                <div class="user-status request">
                  ...
                  <a class="user-status-avatar" href="profile-timeline.html">
                    ...
                    <div class="user-avatar small no-outline">
                      ...
                      <div class="user-avatar-content">
                        <!-- HEXAGON -->
                        <div class="hexagon-image-30-32" data-src="{{asset('assets/frontend/img/avatar/11.jpg')}}"></div>
                        <!-- /HEXAGON -->
                      </div>
                      <!-- /USER AVATAR CONTENT -->
            ...
            <div class="dropdown-box-list" data-simplebar>
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="user-status notification">
                  ...
                  <!-- USER STATUS TITLE -->
                  <p class="user-status-title"><a class="bold" href="profile-timeline.html">Sarah Diamond</a> left a like <img class="reaction" src="{{asset('assets/frontend/img/reaction/like.png')}}" alt="reaction-like"> reaction on your <a class="highlighted" href="profile-timeline.html">status update</a></p>
                  <!-- /USER STATUS TITLE -->
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="user-status notification">
                  ...
                  <!-- USER STATUS TITLE -->
                  <p class="user-status-title"><a class="bold" href="profile-timeline.html">The Green Goo</a> left a love <img class="reaction" src="{{asset('assets/frontend/img/reaction/love.png')}}" alt="reaction-love"> reaction on your <a class="highlighted" href="profile-timeline.html">status update</a></p>
                  <!-- /USER STATUS TITLE -->
