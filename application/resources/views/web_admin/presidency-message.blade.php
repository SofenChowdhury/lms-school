            ...
            <div class="card">
                ...
                <div class="body">
                    <form id="basic-form" method="post" novalidate>
                        <div class="row">
                            <div class="col-md-12">
                                @foreach($presidency_message as $key)
                                <div class="col-md-4" style="background:#ddd; margin-right: 15px;padding: 15px;    border-radius: 12px;">
                                    ...
                                    <p style="text-align: center;">{{ $key->designation }}<br>{{ $key->institute_name }}</p>
                                </div>
                                <br>
                                <h4>{{ $key->title }}</h4><br>
                                ...
                                <p>{!! $key->description !!}</p>
                                <br>
                                <a href="{{ route('update-presidency-message-web',['id'=>$key->id]) }}"><button type="button" class="btn btn-default">Edit</button></a>
                                @endforeach
                            </div>
                        </div>
                    </form>
