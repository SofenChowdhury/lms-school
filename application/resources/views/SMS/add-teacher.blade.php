        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <form  method="post" action="{{ route('submitTeacherFrom') }}" validate enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-2" >
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <input type="date" name="birthday" placeholder="Enter birthday" class="form-control" >
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="col-md-2" >
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <input type="date" name="joining_date" placeholder="Enter joining date" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <input type="" name="phone" maxlength="11" minlength="11" placeholder="Enter phone no." class="form-control" >
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="col-md-2" >
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <input type="number" min="1" name="teacher_card_id" placeholder="Enter teacher card_id" class="form-control" >
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="col-md-2" >
