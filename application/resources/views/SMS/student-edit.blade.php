        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <form id="basic-form" method="post" action="{{ route('updatestudent') }}" validate enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <input type="" maxlength="11" minlength="11" value="{{$student->student_phone}}" name="phone" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="col-md-2" >
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <select  name="class" class="form-control" id="class_id">
                                        <option value="{{$student->student_class_id}}">{{$student->class_name}}</option>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <select  name="section" class="form-control" id="saction_id">
                                        <option value="{{$student->saction_id}}">{{$student->section_name}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <select  name="group" class="form-control">
                                        <option value="{{$student->student_group}}">{{$student->student_group}}</option>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <select  name="op_subject" class="form-control">
                                        <option value="{{$student->student_optional_subject}}">{{$student->student_optional_subject}}</option>
                                        <option value="">Select ptional Subject</option>
                                        @foreach($manage_subjects as $subject)
                                        <option value="{{$subject->subject_subject_name}}">{{$subject->subject_subject_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <input type="number" name="student_card_id" class="form-control" value="{{$student->student_card_id}}" placeholder="Insert The ID card Number ....">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="col-md-2" >
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="{{$student->student_register_no}}" name="resgister_no" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="col-md-2" >
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="{{$student->student_roll_no}}" name="roll" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="col-md-2" >
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="{{$student->student_remarks}}"  name="remarks" class="form-control">
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" value="{{$user->user_id}}" name="user_id" class="form-control" readonly="">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="col-md-2">
