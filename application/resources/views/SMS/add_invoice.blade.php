            ...
            <div class="card">
                ...
                <div class="body">
                    @include('includes.messages')
                     <form  method="post" action="{{ route('submitInvoiceFrom') }}" validate enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-8">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                   <div class="col-md-2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select  name="fee_type_id" class="form-control addon addon-select" id="addon-select">
...
<script>
    $('#class_id').change(function(){
        ...
        $.ajax({
                url: "{{ url('find-fee-type') }}"+'/'+class_id,
                method: 'get',
                success: function(result){
                    $('#addon-select')
                    .find('option')
        ...
        $.ajax({
                ...
                success: function(result){ 
                     ...
                     for ( var i = 0, l = result.length; i < l; i++ ) {
                        ...
                        $('#feeTypeInput').append('<input type="hidden" name="fee_type_id[]" value="'+feeTypes[i]+'">');

                      }
                     $("#totalamount").append('<span>Total Amount :'+ totalamount+' </span>');
                     $("#totalamountInput").append('<input type="hidden" name="totalfee" value="'+ totalamount+'">');
