            ...
            <div class="card">
                ...
                <div class="body">
                    @include('includes.messages')
                     <form  method="post" action="{{ route('submitTransportMemberFrom') }}" validate enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                               <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                ...
                                <div class="col-md-6">
                                    <select  name="transport_id" class="form-control">
                                        ...
                                        @foreach($manage_transport as $key)
                            ...
                            <div class="col-md-12">
                               <div class="col-md-2">
                                ...
                                <div class="col-md-6">
                                    <input type="number" name="transport_fees" class="form-control" >
                                </div>
                            </div>
                        </div>
                        <br>
