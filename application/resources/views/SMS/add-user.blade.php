                ...
                <div class="header">
                    <div class="row">
                        ...
                        <div class="col-lg-6" style="float: right;">
                            <a href="{{ route('users') }}" class="btn btn-primary  pull-right"> <i class="fa fa fa-list-alt"></i> {{ $title }} List</a>
                        </div>
                    </div>
                </div>
                <div class="body">
                    @include('includes.messages')
                    <form id="basic-form" action="{{route('submitUserInfoForm')}}" method="post" validate enctype="multipart/form-data">
                        @csrf()
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-2" >
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="user_religion" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="col-md-2" >
                                ...
                                <div class="col-md-6">
                                    <input type="date" name="user_join_date" class="form-control">
                                </div>
                            </div>
