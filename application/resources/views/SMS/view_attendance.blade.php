...
$attn_date_present=[];
$attn_date_abs=[];
foreach($manage_attn_present as $attn){
    $attn_date_present[] = date('d', strtotime($attn->date));
}
foreach($manage_attn__abs as $attn){
    $attn_date_abs[] = date('d', strtotime($attn->date));
}
@endphp
        ...
        <div class="container-fluid">           
            ...
            <div class="row clearfix">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xm-12">
                    @foreach($manage_student as $v_student)
                        <div class="card profile-header">
                            <div class="body text-center">
                                ...
                                <div>
                                    ...
                                    <span>{{$v_student->student_address}}</span><br><br>
                                </div>
                                <table class="table" style="border:1px solid lightgray;">
                                    <tr>
                                        <td>Registeration</td>
                                        <td>:</td>
                                        <td>{{$v_student->student_register_no}}</td>
                                    </tr>
                                    <tr>
                                        <td>Role number</td>
                                        <td>:</td>
                                        <td>{{$v_student->student_roll_no}}</td>
                                    </tr>
                                    <tr>
                                        <td>Class</td>
                                        <td>:</td>
                                        <td>{{$v_student->class_name}}</td>
                                    </tr>
                                    <tr>
                                        <td>Section</td>
                                        <td>:</td>
                                        <td>{{$v_student->section_name}}</td>
                                    </tr>
                                </table>
                                <div class="mt-3">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xm-12">
                    <div class="card">
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs-new">
                                ...
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Parents">Parents</a></li>
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Routine">Routine</a></li>
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Attendance">Attendance</a></li>
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Mark">Mark</a></li>
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Invoice">Invoice</a></li>
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Payment">Payment</a></li>
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Discount">Discount</a></li>
                    ...
                    <div class="tab-content padding-0">
                                           ...
                                           <div class="row"  style="width: 100%; overflow-x: scroll;">
                                                ...
                                                <div class="col-md-6">
                                                    <table class="table table-bordered" >
                                                        <tr style="background-color: #4391b1;">
                                                            <th>#Month</th>
                                                            <th>01</th>
                                                            <th>02</th>
                                                            <th>03</th>
                                                        ...
                                                        <tr>
                                                            <td>{{'JAN'}}</td>
                                                            @for($i=1; $i<='31'; $i++)
                                                                @if(in_array($i, $attn_date_present))
                                                                    <td style="background:green">P</td>
                                                                @elseif(in_array($i, $attn_date_abs))
                        ...
                        <div class="tab-pane blog-page " id="Parents">
                            <div class="row clearfix text-center">
                                <div class="col-lg-12 col-md-12">
                                    <div class="card">
                                        <div class="body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <p style="text-align: left;"><span>Guardian </span>: Md Mahmud</p>
                                                </div>
                                                <div class="col-md-4">
                                                    <p style="text-align: left;"><span>Father's Name </span>: Md.Rana</p>
                                                </div>
                                                <div class="col-md-4">
                                                    <p style="text-align: left;"><span>Mother's Name </span>: MS.Khadija khatun</p>
                                                </div>
                                                <div class="col-md-4">
                                                    <p style="text-align: left;"><span>Father's Profession </span>: </p>
                                                </div>
                                                <div class="col-md-4">
                                                    <p style="text-align: left;"><span>Mother's Profession </span>: </p>
                                                </div>
                                                <div class="col-md-4">
                                                    <p style="text-align: left;"><span>Email </span>: mahmud@gmail.com</p>
                                                </div>
                                                <div class="col-md-4">
                                                    <p style="text-align: left;"><span>Phone </span>: 01715464884</p>
                                                </div>
                                                <div class="col-md-4">
                                                    <p style="text-align: left;"><span>Username </span>: parent1</p>
                                                </div>
                                                <div class="col-md-4">
                                                    <p style="text-align: left;"><span>Address </span>: Mirpur-2,Dhaka</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>                                
                            ...
                            <div class="card">
                                ...
                                <div class="body">                                    
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <h6>Email from BAI World (Pvt.) Ltd.</h6>
                                            <p style="text-align:left"> I'd like to receive the following emails:</p>
