                ...
                <div class="body">
                    ...
                    <div class="table-responsive">
                        <table id="tableid" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                @foreach($Manage_Library_teacher as $key)
                                <tr>
                                    <td>{{$loop->index+1}}</td>
                                    ...
                                    @if(Auth::user()->role == 'Admin' || Auth::user()->role == 'SUPPERADMIN')
                                    <td class="actions">
                                        <a href="{{route('edit_library_member_teacher',['id'=>$key->member_id])}}"><button class="btn btn-sm btn-icon btn-pure btn-default on-default m-r-5 button-edit"
